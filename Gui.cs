...
public static class Gui
{
   ...
   /// <summary>
   /// Generates Buttons for each map mode
   /// </summary>
   ...
   /// <summary>
   /// Create a Button fore 2 Map Modes nexto each other
   /// </summary>
   ...
   public static void ColorMap()
   {
      ...
      //Vars.Map.Save("C:\\Users\\david\\Downloads\\Smap.bmp", ImageFormat.Bmp); // TODO: Remove on the final version
      Vars.Stopwatch.Stop();
      UpdateBorder();
