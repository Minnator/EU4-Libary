...
namespace EU4_Parse_Lib
{
   public static class Util
   {
      ...
      public static void AddCollectionToSelectedProvinces(List<Province> provinces)
      {
         List<int> id = new();
         ...
         Gui.SelectProvinceCollection(id);
      }


      /// <summary>
      /// Verifies if a country tag matches format and if a country for it exists
      /// </summary>
      /// <param name="tag"></param>
      /// <returns></returns>
      public static bool VerifyTag(string tag)
      {
         if (!Regex.IsMatch(tag, @"[A-Z0-9]{3}"))
            return false;
         //TODO check whether a country for the given Tag exists
         return true;
      }
